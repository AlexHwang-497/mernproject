...
// *{post}; we are destructruing the props and jsut taking 'post'
// * <Typography variant='body2'>{moment(post.createdAt).fromNow()}</Typography>; this tells us like 5 seconds ago for example
const Post = ({post}) =>{
